<x-app-layout :title="$title" :desc="$desc">
    <div class="ml-64 mt-4 overflow-x-auto p-2 bg-gray-100 border border-gray-200 shadow-md shadow-black/10 rounded-md">
        ...
        <div class="justify-center flex flex-col items-center">
            ...
            <div class="">
                <span class="text-gray-600 font-bold text-xs text-center">Semester {{ $semester ?? 1 }} Tahun
                    {{ $year ?? date('Y') }}</span>
            </div>
            <div class="">
        ...
        <div class="flex justify-between mr-1">
            <div class="mt-2 mx-2">
                <button id="" class="p-1.5 rounded-md text-white bg-blue-500"
                                                ...
                                                <div class="flex justify-center">
                                                    <div
                                                        ...
                                                        <div id="checkbox-container-{{ $modalId }}"
                                                            ...
                                                            @php
                                                                // Cek apakah user yang login punya otoritas untuk KPI ini di tabel matrix
                                                            ...
                                                            <div class="p-0">
                                                                <label class="text-[14px]">
                                                                    <input type="checkbox" class="status-checkbox"
                                                                        ...
                                                                        {{ $role == 'Checker 1' || $role == 'Checker WS' || $role == 'Checker Factory' || $role == 'FAD' || $email == 'widya.citra@bskp.co.id' || $canCheck1 == true ? '' : 'disabled' }}>
                                                                    Check 1
                                                                </label>
                                                            ...
                                                            <div class="p-0">
                                                                <label class="text-[14px]">
                                                                    <input type="checkbox" class="status-checkbox"
                                                                        ...
                                                                        {{ $role == 'Checker Div 1' || ($role == 'Checker Div 2' && $actual->status == 'Checked 1') || $canCheck2 == true  ? '' : 'disabled' }}>
                                                                    Check 2
                                                                </label>
                                                                <div class="flex justify-center gap-x-2 mt-1.5">
                                                                    <div class="flex flex-col">
                                                            ...
                                                            <div class="p-0">
                                                                <label class="text-[14px]">
                                                                    <input type="checkbox" class="status-checkbox"
                                                                        ...
                                                                        {{ $role == 'Mng Approver' || $canMngApprove == true ? '' : 'disabled' }}>
                                                                    Approved {{ '(Mng)' }}
                                                                </label>
                                                                <div class="flex justify-center gap-x-2 mt-1.5">
                                                                    <div class="flex flex-col">
                                                            ...
                                                            <div class="p-0">
                                                                <label class="text-[14px]">
                                                                    <input type="checkbox" class="status-checkbox"
                                                                        ...
                                                                        {{ $role == 'Approver' || $canApproveFinal == true ? '' : 'disabled' }}>
                                                                    Final Check {{ '(HRD Spv)' }}
                                                                </label>
                                                                <div class="flex justify-center gap-x-2 mt-1.5">
                                                                    <div class="flex flex-col">
                                                                ...
                                                                <div class="flex justify-center gap-x-2 mt-1.5">
                                                                    <div class="flex flex-col">
                                                                        <span class="text-[9px] text-center">Final
                                                                            Check By:</span>
                                                                        @if ($actual->approved_by)
                                                                            {{-- Memperbaiki tampilan nama/tanggal agar menggunakan format yang benar --}}
                                                                            <span
                                                                                class="text-[9px] text-center">{{ $actual->approved_by }}</span>
                                                                        @else
                                                                            <span
                                                                                class="text-[9px] text-center text-red-500">N/A</span>
                                                                        @endif
                                                                    </div>
                                                                    <div class="flex flex-col">
                                                                        <span class="text-[9px] text-center">Final
                                                                        ...
                                                                        @if ($actual->approved_at)
                                                                            <span
                                                                                class="text-[9px] text-center">{{ \Carbon\Carbon::parse($actual->approved_at)->format('d M Y H:i') }}</span>
                                                                        @else
                                                                            <span
                                                                                class="text-[9px] text-center text-red-500">N/A</span>
                                                                        @endif
