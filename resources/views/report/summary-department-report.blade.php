    ...
    <div class="ml-64 mt-4 overflow-x-auto p-2 bg-gray-100 border border-gray-200 shadow-md shadow-black/10 rounded-md">
        ...
        <div class="p-0">
            <table id="exportTable" class="w-full bg-white table-fixed">
                <th data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true" data-fill-color="FF0066FF"
                    data-f-color="FFFFFFFF"
                    class="border border-gray-400 text-[13px] tracking-wide font-medium text-white py-0.5 px-2 bg-blue-700"
                    rowspan="2" style="width: 3%">No.</th>
                <th data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true" data-fill-color="FF0066FF"
                    data-f-color="FFFFFFFF"
                    class="border border-gray-400 text-[13px] tracking-wide font-medium text-white py-0.5 px-2 bg-blue-700"
                    rowspan="2" style="width: 10%">Dept</th>
                <th data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true" data-fill-color="FF0066FF"
                    data-f-color="FFFFFFFF"
                    class="border border-gray-400 text-[13px] tracking-wide font-medium text-white py-0.5 px-2 bg-blue-700"
                    rowspan="2" style="width: 6%">NIK</th>
                <th data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true" data-fill-color="FF0066FF"
                    data-f-color="FFFFFFFF"
                    class="border border-gray-400 text-[13px] tracking-wide font-medium text-white py-0.5 px-2 bg-blue-700"
                    rowspan="2" style="width: 23%">Nama</th>
                <th data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true" data-fill-color="FF0066FF"
                    data-f-color="FFFFFFFF"
                    class="border border-gray-400 text-[13px] tracking-wide font-medium text-white py-0.5 px-2 bg-blue-700"
                    rowspan="2" style="width: 12%">Posisi</th>
                <th data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true" data-fill-color="FF0066FF"
                    data-f-color="FFFFFFFF"
                    class="border border-gray-400 text-[13px] tracking-wide font-medium text-white py-0.5 px-2 bg-blue-700"
                    colspan="3">Pencapaian KPI Dept 30%</th>
                <th data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                    data-fill-color="FF0066FF" data-f-color="FFFFFFFF"
                    class="border border-gray-400 text-[13px] tracking-wide font-medium text-white py-0.5 px-2 bg-blue-700"
                    colspan="3">Pencapaian KPI Individu 70%</th>
                <th style="width: 6%" data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                    data-fill-color="FF0066FF" data-f-color="FFFFFFFF"
                    class="border border-gray-400 text-[13px] tracking-wide font-medium text-white py-0.5 px-2 bg-blue-700"
                    rowspan="2">Total Rata Rata</th>
                <tr>
                    <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                        data-fill-color="FF0066FF" data-f-color="FFFFFFFF"
                        class="border border-gray-400 text-[13px] tracking-wide font-medium text-white py-0.5 px-2 bg-blue-700 text-center">
                        Semester 1</td>
                    <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                        data-fill-color="FF0066FF" data-f-color="FFFFFFFF"
                        class="border border-gray-400 text-[13px] tracking-wide font-medium text-white py-0.5 px-2 bg-blue-700 text-center">
                ...
                @foreach ($employees as $index => $employee)
                    @php
                        ...
                        if ($departmentId == 11) {
                            $sumSemester1Dept = collect([13, 14, 15, 16, 17, 18])->avg(
                                fn($id) => $sumGroupSemester1Dept[$id] ?? 0,
                            );
                            $sumSemester2Dept = collect([13, 14, 15, 16, 17, 18])->avg(
                                fn($id) => $sumGroupSemester2Dept[$id] ?? 0,
                            );
                            $totalSumDept = collect([13, 14, 15, 16, 17, 18])->avg(
                                fn($id) => $totalSumSemesterDept[$id] ?? 0,
                            );
                        } elseif ($departmentId == 21) {
                            $sumSemester1Dept = collect([13, 14, 15])->avg(
                                fn($id) => $sumGroupSemester1Dept[$id] ?? 0,
                            );
                            $sumSemester2Dept = collect([13, 14, 15])->avg(
                                fn($id) => $sumGroupSemester2Dept[$id] ?? 0,
                            );
                            $totalSumDept = collect([13, 14, 15])->avg(
                                fn($id) => $totalSumSemesterDept[$id] ?? 0,
                            );
                        } elseif ($departmentId == 22) {
                            $sumSemester1Dept = collect([16, 17, 18])->avg(
                                fn($id) => $sumGroupSemester1Dept[$id] ?? 0,
                            );
                            $sumSemester2Dept = collect([16, 17, 18])->avg(
                                fn($id) => $sumGroupSemester2Dept[$id] ?? 0,
                            );
                            $totalSumDept = collect([16, 17, 18])->avg(
                                fn($id) => $totalSumSemesterDept[$id] ?? 0,
                            );
                        } else {
                        ...
                        $totalSemester1Weight = PhpOffice\PhpSpreadsheet\Calculation\Statistical\Averages::average(
                            $sumSemester1,
                        );
                        $totalSemester2Weight = PhpOffice\PhpSpreadsheet\Calculation\Statistical\Averages::average(
                            $sumSemester2,
                        );
                        $totalSemester1DeptWeight = PhpOffice\PhpSpreadsheet\Calculation\Statistical\Averages::average(
                            $sumSemester1Dept,
                        );
                        $totalSemester2DeptWeight = PhpOffice\PhpSpreadsheet\Calculation\Statistical\Averages::average(
                            $sumSemester2Dept,
                        );
                        $totalWeightSum = PhpOffice\PhpSpreadsheet\Calculation\Statistical\Averages::average(
                            $totalSumEmployee,
                        );
                        $totalDeptWeightSum = PhpOffice\PhpSpreadsheet\Calculation\Statistical\Averages::average(
                            $totalSumDept,
                        );
                    ...
                    <tr class="{{ $i % 2 === 0 ? 'bg-white' : 'bg-blue-100' }}">
                        ...
                        @if ($sumSemester1Dept > 0)
                            <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                                <a href="{{ route('report.department', $employee->department_id) }}?year={{ $yearQuery }}&semester=1"
                        ...
                        @if ($sumSemester2Dept > 0)
                            <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                                <a href="{{ route('report.department', $employee->department_id) }}?year={{ $yearQuery }}&semester=2"
                                    class="hover:underline hover:text-blue-600">
                        ...
                        @if ($totalSumDept > 0)
                            <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                                {{ number_format($totalSumDept, 1) }}%</td>
                        @else
                            <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                        ...
                        @if ($sumSemester1 > 0)
                            <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                                <a href="{{ route('report.show', $employee->employee_id) }}?year={{ $yearQuery }}&semester=1"
                                    class="hover:underline hover:text-blue-600">
                        ...
                        @if ($totalSumEmployee > 0)
                            <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                                {{ number_format($totalSumEmployee, 1) }}%</td>
                        @else
                            <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                ...
                @if (request()->query('department') && request()->query('status') == '')
                    ...
                    <tr class="bg-gray-200">
                        ...
                        <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                            data-fill-color="FFF2F2F2"
                            class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                            {{ number_format($totalSemester1DeptWeight, 1) }}%</td>
                        <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                            data-fill-color="FFF2F2F2"
                            class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                            {{ number_format($totalSemester2DeptWeight, 1) }}%</td>
                        <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                            data-fill-color="FFF2F2F2"
                            class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                            {{ number_format($totalDeptWeightSum, 1) }}%</td>
                        <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                            data-fill-color="FFF2F2F2"
                            class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                            {{ number_format($finalTotalSemester1Weight, 1) }}%</td>
                        <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                            data-fill-color="FFF2F2F2"
                            class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                            {{ number_format($finalTotalSemester2Weight, 1) }}%</td>
                        <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                            data-fill-color="FFF2F2F2"
                            class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                            {{ number_format($finalTotalEmployeeWeight, 1) }}%</td>
                        <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                            data-fill-color="FFF2F2F2"
                            class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                            {{ number_format($finalTotalAverage, 1) }}%</td>
                    </tr>
                @endif
            </table>
        </div>
                ...
                <table id="exportTable2" class="w-full">
                    ...
                    @foreach ($inactiveTargetEmployees as $index => $employee)
                        @php
                            ...
                            $totalInactiveSemester1Weight = PhpOffice\PhpSpreadsheet\Calculation\Statistical\Averages::average(
                                $sumInactiveSemester1,
                            );
                            $totalInactiveSemester2Weight = PhpOffice\PhpSpreadsheet\Calculation\Statistical\Averages::average(
                                $sumInactiveSemester2,
                            );
                            $totalInactiveSemester1DeptWeight = PhpOffice\PhpSpreadsheet\Calculation\Statistical\Averages::average(
                                $sumInactiveSemester1Dept,
                            );
                            $totalInactiveSemester2DeptWeight = PhpOffice\PhpSpreadsheet\Calculation\Statistical\Averages::average(
                                $sumInactiveSemester2Dept,
                            );
                            $totalInactiveWeightSum = PhpOffice\PhpSpreadsheet\Calculation\Statistical\Averages::average(
                                $totalInactiveSumEmployee,
                            );
                            $totalInactiveDeptWeightSum = PhpOffice\PhpSpreadsheet\Calculation\Statistical\Averages::average(
                                $totalInactiveSumDept,
                            );
                            $totalInactiveAverage = PhpOffice\PhpSpreadsheet\Calculation\Statistical\Averages::average(
                                $totalAllInactive,
                            );
                        ...
                        <tr class="{{ $i % 2 === 0 ? 'bg-white' : 'bg-blue-100' }}">
                            ...
                            @if ($sumInactiveSemester1Dept > 0)
                                <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                    data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                    class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                                    {{ number_format($sumInactiveSemester1Dept, 1) }}%</td>
                            @else
                                <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                    data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                    class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                            ...
                            @if ($sumInactiveSemester2Dept > 0)
                                <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                    data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                    class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                                    {{ number_format($sumInactiveSemester2Dept, 1) }}%</td>
                            @else
                                <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                    data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                    class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                            ...
                            @if ($totalInactiveSumDept > 0)
                                <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                    data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                    class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                                    {{ number_format($totalInactiveSumDept, 1) }}%</td>
                            @else
                                <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                    data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                    class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                            ...
                            @if ($sumInactiveSemester1 > 0)
                                <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                    data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                    class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                                    {{ number_format($sumInactiveSemester1, 1) }}%</td>
                            @else
                                <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                    data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                    class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                            ...
                            @if ($sumInactiveSemester2 > 0)
                                <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                    data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                    class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                                    {{ number_format($sumInactiveSemester2, 1) }}%</td>
                            @else
                                <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                    data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                    class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                            ...
                            @if ($totalInactiveSumEmployee > 0)
                                <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                    data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                    class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                                    {{ number_format($totalInactiveSumEmployee, 1) }}%</td>
                            @else
                                <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                    data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                    class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                            ...
                            <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                                class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                                {{ number_format($totalAllInactive, 1) }}%</td>
                        </tr>
                    @endforeach
                    @if (request()->query('department'))
                        @php
                            $finalInactiveTotalSemester1Weight =
                                $inactiveRowCount > 0 ? $totalInactiveSemester1WeightSum / $inactiveRowCount : 0;
                            $finalInactiveTotalSemester2Weight =
                                $inactiveRowCount > 0 ? $totalInactiveSemester2WeightSum / $inactiveRowCount : 0;
                            $finalInactiveTotalEmployeeWeight =
                                $finalInactiveTotalSemester1Weight + $finalTotalSemester2Weight;
                            $finalInactiveTotalAverage =
                                $inactiveRowCount > 0 ? $totalInactiveAverageSum / $inactiveRowCount : 0;
                        @endphp
                        <tr class="bg-gray-200">
                            <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                data-fill-color="FFF2F2F2"
                            ...
                            <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                data-fill-color="FFF2F2F2"
                                class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                                {{ number_format($totalInactiveSemester1DeptWeight, 1) }}%</td>
                            <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                data-fill-color="FFF2F2F2"
                                class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                                {{ number_format($totalInactiveSemester2DeptWeight, 1) }}%</td>
                            <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                data-fill-color="FFF2F2F2"
                                class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                            ...
                            <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                data-fill-color="FFF2F2F2"
                                class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                                {{ number_format($finalInactiveTotalSemester1Weight, 1) }}%</td>
                            <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                data-fill-color="FFF2F2F2"
                                class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                                {{ number_format($finalInactiveTotalSemester2Weight, 1) }}%</td>
                            <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                data-fill-color="FFF2F2F2"
                                class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                                {{ number_format($finalInactiveTotalEmployeeWeight, 1) }}%</td>
                            <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                                data-fill-color="FFF2F2F2"
                                class="border border-gray-400 text-[12px] tracking-wide font-medium text-gray-600 py-0.5 px-2 text-center">
                                {{ number_format($finalInactiveTotalAverage, 1) }}%</td>
                        </tr>
                    @endif
                </table>
            </div>
                    ...
                    <div>
                        <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                            @if ($employees->onFirstPage())
                                <span
                                    class="relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 cursor-default">
                            ...
                            @foreach ($employees->getUrlRange(1, $employees->lastPage()) as $page => $url)
                                ...
                                @elseif (
                                    $page == 1 ||
                                        ...
                                        ($page >= $employees->currentPage() - 1 && $page <= $employees->currentPage() + 1))
                                    <a href="{{ $url }}"
                                ...
                                @elseif ($page == $employees->currentPage() - 2 || $page == $employees->currentPage() + 2)
                                    <span
                                        class="relative inline-flex items-center px-4 py-2 text-sm font-semibold text-gray-700 ring-1 ring-inset ring-gray-300 cursor-default">...</span>
                                @endif
                            @endforeach
                            ...
                            @else
                                <span
                                    class="relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 cursor-default">
                                    <span class="sr-only">Next</span>
                                    <svg class="w-5 h-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                        <path fill-rule="evenodd"
                                            d="M8.22 5.22a.75.75 0 0 1 1.06 0l4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.75.75 0 0 1-1.06-1.06L11.94 10 8.22 6.28a.75.75 0 0 1 0-1.06Z"
