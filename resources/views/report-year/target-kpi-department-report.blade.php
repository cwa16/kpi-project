    ...
    <div class="ml-64 mt-4 overflow-x-auto p-2 bg-white border border-gray-100 shadow-md shadow-black/10 rounded-md">
        ...
        <div class="grid grid-cols-2">
            <div class="flex items-start">
                <form action="{{ route('report-year.departmentTargetReport') }}" method="GET">

                    <select name="item" id="item"
                        class="rounded-md py-1.5 pl-3 pr-7 text-base text-gray-500 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                        ...
                        @foreach ($indicatorList as $item)
                            <option value="{{ $item->indicator }}">
                                {{ \Illuminate\Support\Str::limit($item->indicator, 25) }}</option>
                        @endforeach
                    </select>
        ...
        <table class="w-full table-fixed mt-2" id="exportTable">
            <tr>
                <th data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true" data-fill-color="FF0066FF"
                    data-f-color="FFFFFFFF" style="width: 4%;"
                    class="border-2 border-gray-400 text-[14px] tracking-wide font-medium text-white py-1 px-4 bg-blue-700">
                    No.</th>
                <th data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true" data-fill-color="FF0066FF"
                    data-f-color="FFFFFFFF" style="width: 20%"
                    class="border-2 border-gray-400 text-[14px] tracking-wide font-medium text-white py-1 px-4 bg-blue-700">
                    Dept</th>
                <th data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true" data-fill-color="FF0066FF"
                    data-f-color="FFFFFFFF" style="width: 5%;"
                    class="border-2 border-gray-400 text-[14px] tracking-wide font-medium text-white py-1 px-4 bg-blue-700">
                    Trend</th>
                <th data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true" data-fill-color="FF0066FF"
                    data-f-color="FFFFFFFF" style="width: 6%"
                    class="border-2 border-gray-400 text-[14px] tracking-wide font-medium text-white py-1 px-4 bg-blue-700">
                    Periode Review</th>
                <th data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true" data-fill-color="FF0066FF"
                    data-f-color="FFFFFFFF" style="width: 5%"
                ...
                @foreach ($range as $month)
                    <th data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                        ...
                        class="border-2 border-gray-400 text-[14px] tracking-wide font-medium text-white py-1 px-4 bg-blue-700">
                        {{ DateTime::createFromFormat('!m', $month)->format('M') }}</th>
                @endforeach
            </tr>
            @php
                $i = 0;
            ...
            @forelse ($targets as $target)
                ...
                <tr class="{{ $i % 2 === 0 ? 'bg-white' : 'bg-gray-200' }}">
                    ...
                    <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                        data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}" style="width: 3%"
                        class="border-2 border-gray-400 tracking-wide text-[12px] px-2 py-0 text-center">
                        {{ $i }}</td>
                    <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                        data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                        class="border-2 border-gray-400 tracking-wide text-[12px] px-2 py-0">{{ $target->department }}
                    </td>
                    <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                        data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}" style="width: 28%"
                        class="border-2 border-gray-400 tracking-wide text-[12px] px-2 py-0 text-center">
                        {{ $target->trend }}</td>
                    <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                        data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}"
                    ...
                    @foreach ($range as $month)
                        ...
                        <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                            ...
                            @if ($target->$targetUnitField !== null)
                                <a href="{{ route('report-year.department', $target->department_id) }}?year={{ $year }}&semester=1"
            ...
            @empty
                <tr>
                    <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                        data-fill-color="{{ $i % 2 === 0 ? 'FFF2F2F2' : 'FFFFFFFF' }}" colspan="24"
                        class="border-2 border-gray-400 tracking-wide  py-0 px-2 text-center">Data Tidak ditemukan</td>
                </tr>
            @endforelse
            @php
                $monthlySums = [];
                foreach ($range as $month) {
                    $monthlySums[$month] = $actuals
            ...
            <tr class="bg-[#FFE893] font-semibold">
                <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                    data-fill-color="#FFFFE893"
                    class="border-2 border-gray-400 tracking-wide text-[12px] px-2 py-0 text-center"></td>
                <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                    data-fill-color="#FFFFE893" colspan="4"
                    class="border-2 border-gray-400 tracking-wide text-[12px] px-2 py-0 text-center">Total</td>
                @foreach ($range as $month)
                    <td data-b-a-s="thin" data-a-h="center" data-a-v="middle" data-a-wrap="true"
                        data-fill-color="#FFFFE893"
                        class="border-2 border-gray-400 tracking-wide text-[12px] px-2 py-0 text-center">
